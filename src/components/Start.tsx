...
export const Start: React.FC = () => {
  ...
  useEffect(() => {
    if (scene.current != null) {
      ...
      gsap.set([, person, torch, ...haze?.children, questionMark], { autoAlpha: 0 })
      ...
      if (haze != null) {
        timeLine
          ...
          .fromTo(haze.children, { scale: 0.3 }, { duration: .5, scale: 1, autoAlpha: 1, stagger: 0.1 })
          .to(questionMark, { duration: 0.4, autoAlpha: 1 })
      }
    }
  }, [])
